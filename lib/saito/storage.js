...
/////////////////
/**
 * Object that handles all storage functionality
 */
 ...
 * in our database
 * @param {integer} block_id lowest_block_id to keep
 */
 ...
 * @param {string} block_hash starting hash
 */
 ...
 * @param {{"param1":"value1"}} params
 * @param {callback} callback function to call with any results -- defaults null
 */
...
// FIXME: Check description adn types for this function
/**
 * Checks if slip is spent
 * @param {*} slip
 * @param {*} current_bid
 * @returns {boolean} is slip spent?
 */
 ...
 * @param {number} mylimit limit to load blocks from disk -- defaults to 0
 */
 ...
 * @param {boolean} lc is longest chain?
 */
 ...
 *
 * @param {string} block_hash block hash
 * @param {callback} mycallback (storage_self, block)
 */
 ...
 * @param {callback} mycallback function that returns (storage_self, block)
 */
 ...
 *
 * @param {string} sql sql command
 * @param {{"param1":"value1"}} params parameters for sql command
 * @param {callback} callback function to call with any results
 */
 ...
 *
 * @param {integer} bid block_id
 * @param {integer} tid transaction_id
 * @param {integer} sid slip_id
 * @param {string} add address
 * @param {decimal} amt amount
 * @param {string} block_hash block hash
 */
 ...
 * @param blk block hash
 * @param lc longest_chain
 */
 ...
 * the database.
 *
 * @param {string} hash block_hash
 * @param {integer} conf confirmation num
 */
 ...
 *
 * TODO: Move this logic to the peer class
 *
 * @param {integer} start_bid block_id to start syncing from
 * @param {string} synctape "full" or "lite"
 * @param {saito.peer} peer peer to send data to
 */
 ...
 *
 * @param {saito.block} newblock Saito block
 */
 ...
 * block
 *
 * @param {saito.block} blk Saito block
 */
 ...
 *
 * @param {saito.block} newblock newest Saito block
 * @param {interger} pos newest block index in blockchain.index
 * @param {integer} shared_ancestor_index_pos block index of last-common-ancestor blockchain.index
 * @param {array} new_block_idxs array of block indexes for new blocks becoming longest chain
 ...
 * @param {string} forceAdd "force" if block is loaded from disk
 * @param {integer} current_unwind_index position in above old_block_* arrays of this block
...
/**
 * Validates if all inputs in a block valid
 *
 * @param {saito.block} newblock
 * @returns {boolean} is valid block input?
 */
 ...
 * invalid block.
 *
 * @param {saito.transaction} tx transaction to check
 * @param {callback} mycallback callback on success
 */
